...
void room_features();
int feat_r_d2();
void feat_r_d1(char [],int [],int,int);
void availability();
void booking_room();
void cust_detail();
void food_order();
...
void feat_r_d1(char type[12],int room_no[5],int no_bed,int room_char)
{
   int i;
   clrscr();
   hotel_name2();
